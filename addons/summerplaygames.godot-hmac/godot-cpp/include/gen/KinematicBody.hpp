...
public:
	...
	// methods
	Ref<KinematicCollision> move_and_collide(const Vector3 rel_vec, const bool infinite_inertia = true, const bool test_only = false);
	...
	Vector3 move_and_slide_with_snap(const Vector3 linear_velocity, const Vector3 snap, const Vector3 floor_normal = Vector3(0, 0, 0), const bool stop_on_slope = false, const int64_t max_slides = 4, const double floor_max_angle = 0.785398, const bool infinite_inertia = true);
