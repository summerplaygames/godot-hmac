...
public:
	...
	// methods
	void force_sync();
	void force_draw(const bool swap_buffers = true, const double frame_step = 0);
	void sync();
	void draw(const bool swap_buffers = true, const double frame_step = 0);
	RID texture_create();
	...
	void mesh_add_surface_from_arrays(const RID mesh, const int64_t primtive, const Array arrays, const Array blend_shapes = Array(), const int64_t compress_format = 97280);
	...
	void gi_probe_set_energy(const RID probe, const double energy);
	double gi_probe_get_energy(const RID probe) const;
	void gi_probe_set_bias(const RID probe, const double bias);
	double gi_probe_get_bias(const RID probe) const;
	void gi_probe_set_normal_bias(const RID probe, const double bias);
	double gi_probe_get_normal_bias(const RID probe) const;
	void gi_probe_set_propagation(const RID probe, const double propagation);
	double gi_probe_get_propagation(const RID probe) const;
	...
	void environment_set_ssao(const RID env, const bool enable, const double radius, const double intensity, const double radius2, const double intensity2, const double bias, const double light_affect, const double ao_channel_affect, const Color color, const int64_t quality, const int64_t blur, const double bilateral_sharpness);
	void environment_set_fog(const RID env, const bool enable, const Color color, const Color sun_color, const double sun_amount);
	void environment_set_fog_depth(const RID env, const bool enable, const double depth_begin, const double depth_end, const double depth_curve, const bool transmit, const double transmit_curve);
