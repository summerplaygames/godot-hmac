...
void Tabs::_update_hover() {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Tabs", "_update_hover");
	}
...
void Tabs::set_drag_to_rearrange_enabled(const bool enabled) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Tabs", "set_drag_to_rearrange_enabled");
	}
	___godot_icall_void_bool(mb, (const Object *) this, enabled);
}
...
bool Tabs::get_drag_to_rearrange_enabled() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Tabs", "get_drag_to_rearrange_enabled");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
...
void Tabs::set_tabs_rearrange_group(const int64_t group_id) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Tabs", "set_tabs_rearrange_group");
	}
...
int64_t Tabs::get_tabs_rearrange_group() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Tabs", "get_tabs_rearrange_group");
	}
	return ___godot_icall_int(mb, (const Object *) this);
}
...
void Tabs::set_select_with_rmb(const bool enabled) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Tabs", "set_select_with_rmb");
	}
	___godot_icall_void_bool(mb, (const Object *) this, enabled);
}
...
bool Tabs::get_select_with_rmb() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Tabs", "get_select_with_rmb");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
