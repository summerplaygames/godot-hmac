...
void SpatialMaterial::set_depth_deep_parallax_flip_tangent(const bool flip) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("SpatialMaterial", "set_depth_deep_parallax_flip_tangent");
	}
	___godot_icall_void_bool(mb, (const Object *) this, flip);
}

bool SpatialMaterial::get_depth_deep_parallax_flip_tangent() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("SpatialMaterial", "get_depth_deep_parallax_flip_tangent");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
...
void SpatialMaterial::set_depth_deep_parallax_flip_binormal(const bool flip) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("SpatialMaterial", "set_depth_deep_parallax_flip_binormal");
	}
	___godot_icall_void_bool(mb, (const Object *) this, flip);
}
...
bool SpatialMaterial::get_depth_deep_parallax_flip_binormal() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("SpatialMaterial", "get_depth_deep_parallax_flip_binormal");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
...
SpatialMaterial::DistanceFadeMode SpatialMaterial::get_distance_fade() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("SpatialMaterial", "get_distance_fade");
	}
	return (SpatialMaterial::DistanceFadeMode) ___godot_icall_int(mb, (const Object *) this);
}
