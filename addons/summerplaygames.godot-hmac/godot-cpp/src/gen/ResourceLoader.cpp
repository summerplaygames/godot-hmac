...
bool ResourceLoader::has_cached(const String path) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("_ResourceLoader", "has_cached");
	}
...
bool ResourceLoader::exists(const String path, const String type_hint) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("_ResourceLoader", "exists");
	}
	return ___godot_icall_bool_String_String(mb, (const Object *) this, path, type_hint);
}
