...
void Spatial::set_disable_scale(const bool disable) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Spatial", "set_disable_scale");
	}
...
bool Spatial::is_scale_disabled() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Spatial", "is_scale_disabled");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
...
void Spatial::force_update_transform() {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Spatial", "force_update_transform");
	}
