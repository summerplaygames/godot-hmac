...
double AnimationTreePlayer::animation_node_get_position(const String id) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("AnimationTreePlayer", "animation_node_get_position");
	}
