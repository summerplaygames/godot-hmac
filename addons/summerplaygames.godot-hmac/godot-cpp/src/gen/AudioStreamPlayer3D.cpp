...
void AudioStreamPlayer3D::set_stream_paused(const bool pause) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("AudioStreamPlayer3D", "set_stream_paused");
	}
	___godot_icall_void_bool(mb, (const Object *) this, pause);
}

bool AudioStreamPlayer3D::get_stream_paused() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("AudioStreamPlayer3D", "get_stream_paused");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
