...
void AudioStreamPlayer::set_stream_paused(const bool pause) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("AudioStreamPlayer", "set_stream_paused");
	}
...
bool AudioStreamPlayer::get_stream_paused() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("AudioStreamPlayer", "get_stream_paused");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
