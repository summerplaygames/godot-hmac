...
void PopupMenu::add_radio_check_item(const String label, const int64_t id, const int64_t accel) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PopupMenu", "add_radio_check_item");
	}
	___godot_icall_void_String_int_int(mb, (const Object *) this, label, id, accel);
}
...
void PopupMenu::add_radio_check_shortcut(const Ref<ShortCut> shortcut, const int64_t id, const bool global) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PopupMenu", "add_radio_check_shortcut");
	}
	___godot_icall_void_Object_int_bool(mb, (const Object *) this, shortcut.ptr(), id, global);
}
...
void PopupMenu::set_item_as_radio_checkable(const int64_t idx, const bool enable) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PopupMenu", "set_item_as_radio_checkable");
	}
	___godot_icall_void_int_bool(mb, (const Object *) this, idx, enable);
}
...
void PopupMenu::set_item_shortcut_disabled(const int64_t idx, const bool disabled) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PopupMenu", "set_item_shortcut_disabled");
	}
	___godot_icall_void_int_bool(mb, (const Object *) this, idx, disabled);
}
...
bool PopupMenu::is_item_radio_checkable(const int64_t idx) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PopupMenu", "is_item_radio_checkable");
	}
	return ___godot_icall_bool_int(mb, (const Object *) this, idx);
}
...
bool PopupMenu::is_item_shortcut_disabled(const int64_t idx) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PopupMenu", "is_item_shortcut_disabled");
	}
	return ___godot_icall_bool_int(mb, (const Object *) this, idx);
}
...
void PopupMenu::add_separator(const String label) {
	...
	___godot_icall_void_String(mb, (const Object *) this, label);
}
...
void PopupMenu::set_submenu_popup_delay(const double seconds) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PopupMenu", "set_submenu_popup_delay");
	}
...
double PopupMenu::get_submenu_popup_delay() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PopupMenu", "get_submenu_popup_delay");
	}
...
void PopupMenu::set_hide_on_window_lose_focus(const bool enable) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PopupMenu", "set_hide_on_window_lose_focus");
	}
	___godot_icall_void_bool(mb, (const Object *) this, enable);
}
...
bool PopupMenu::is_hide_on_window_lose_focus() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PopupMenu", "is_hide_on_window_lose_focus");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
