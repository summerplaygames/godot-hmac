...
void GraphEdit::set_connection_activity(const String from, const int64_t from_port, const String to, const int64_t to_port, const double amount) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("GraphEdit", "set_connection_activity");
	}
	___godot_icall_void_String_int_String_int_float(mb, (const Object *) this, from, from_port, to, to_port, amount);
}
...
HBoxContainer *GraphEdit::get_zoom_hbox() {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("GraphEdit", "get_zoom_hbox");
	}
	return (HBoxContainer *) ___godot_icall_Object(mb, (const Object *) this);
}
