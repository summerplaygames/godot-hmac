...
Error Image::generate_mipmaps(const bool renormalize) {
	...
	return (Error) ___godot_icall_int_bool(mb, (const Object *) this, renormalize);
}
...
Ref<Image> Image::rgbe_to_srgb() {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Image", "rgbe_to_srgb");
	}
	return Ref<Image>::__internal_constructor(___godot_icall_Object(mb, (const Object *) this));
}

void Image::bumpmap_to_normalmap(const double bump_scale) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Image", "bumpmap_to_normalmap");
	}
	___godot_icall_void_float(mb, (const Object *) this, bump_scale);
}
...
Color Image::get_pixelv(const Vector2 src) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Image", "get_pixelv");
	}
	return ___godot_icall_Color_Vector2(mb, (const Object *) this, src);
}
...
void Image::set_pixelv(const Vector2 dst, const Color color) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Image", "set_pixelv");
	}
	___godot_icall_void_Vector2_Color(mb, (const Object *) this, dst, color);
}
...
Error Image::load_webp_from_buffer(const PoolByteArray buffer) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Image", "load_webp_from_buffer");
	}
	return (Error) ___godot_icall_int_PoolByteArray(mb, (const Object *) this, buffer);
}
