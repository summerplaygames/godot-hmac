...
void Range::set_allow_greater(const bool allow) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Range", "set_allow_greater");
	}
...
bool Range::is_greater_allowed() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Range", "is_greater_allowed");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
...
void Range::set_allow_lesser(const bool allow) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Range", "set_allow_lesser");
	}
	___godot_icall_void_bool(mb, (const Object *) this, allow);
}
...
bool Range::is_lesser_allowed() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Range", "is_lesser_allowed");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
