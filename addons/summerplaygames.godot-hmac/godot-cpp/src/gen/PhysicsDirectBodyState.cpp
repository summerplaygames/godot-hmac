...
void PhysicsDirectBodyState::apply_central_impulse(const Vector3 j) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PhysicsDirectBodyState", "apply_central_impulse");
	}
...
double PhysicsDirectBodyState::get_contact_impulse(const int64_t contact_idx) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PhysicsDirectBodyState", "get_contact_impulse");
	}
	return ___godot_icall_float_int(mb, (const Object *) this, contact_idx);
}
