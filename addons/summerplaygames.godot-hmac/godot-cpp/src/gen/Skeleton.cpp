...
void Skeleton::physical_bones_stop_simulation() {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Skeleton", "physical_bones_stop_simulation");
	}
	___godot_icall_void(mb, (const Object *) this);
}
...
void Skeleton::physical_bones_start_simulation(const Array bones) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Skeleton", "physical_bones_start_simulation");
	}
...
void Skeleton::physical_bones_add_collision_exception(const RID exception) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Skeleton", "physical_bones_add_collision_exception");
	}
	___godot_icall_void_RID(mb, (const Object *) this, exception);
}

void Skeleton::physical_bones_remove_collision_exception(const RID exception) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Skeleton", "physical_bones_remove_collision_exception");
	}
	___godot_icall_void_RID(mb, (const Object *) this, exception);
}

void Skeleton::set_bone_ignore_animation(const int64_t bone, const bool ignore) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Skeleton", "set_bone_ignore_animation");
	}
	___godot_icall_void_int_bool(mb, (const Object *) this, bone, ignore);
}
