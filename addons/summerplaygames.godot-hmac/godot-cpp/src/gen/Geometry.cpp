...
Variant Geometry::line_intersects_line_2d(const Vector2 from_a, const Vector2 dir_a, const Vector2 from_b, const Vector2 dir_b) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("_Geometry", "line_intersects_line_2d");
	}
	return ___godot_icall_Variant_Vector2_Vector2_Vector2_Vector2(mb, (const Object *) this, from_a, dir_a, from_b, dir_b);
}
