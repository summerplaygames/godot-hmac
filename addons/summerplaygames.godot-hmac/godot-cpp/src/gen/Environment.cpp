...
void Environment::set_fog_depth_end(const double distance) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Environment", "set_fog_depth_end");
	}
	___godot_icall_void_float(mb, (const Object *) this, distance);
}
...
double Environment::get_fog_depth_end() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Environment", "get_fog_depth_end");
	}
	return ___godot_icall_float(mb, (const Object *) this);
}
...
void Environment::set_ssao_ao_channel_affect(const double amount) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Environment", "set_ssao_ao_channel_affect");
	}
	___godot_icall_void_float(mb, (const Object *) this, amount);
}
...
double Environment::get_ssao_ao_channel_affect() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Environment", "get_ssao_ao_channel_affect");
	}
	return ___godot_icall_float(mb, (const Object *) this);
}
