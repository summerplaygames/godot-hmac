...
Object *Control::_make_custom_tooltip(const String for_text) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Control", "_make_custom_tooltip");
	}
	return (Object *) ___godot_icall_Object_String(mb, (const Object *) this, for_text);
}

bool Control::_clips_input() {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Control", "_clips_input");
	}
