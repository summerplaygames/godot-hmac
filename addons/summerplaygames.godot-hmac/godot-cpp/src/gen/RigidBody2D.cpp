...
void RigidBody2D::set_physics_material_override(const Ref<PhysicsMaterial> physics_material_override) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RigidBody2D", "set_physics_material_override");
	}
...
Ref<PhysicsMaterial> RigidBody2D::get_physics_material_override() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RigidBody2D", "get_physics_material_override");
	}
...
void RigidBody2D::_reload_physics_characteristics() {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RigidBody2D", "_reload_physics_characteristics");
	}
...
void RigidBody2D::apply_central_impulse(const Vector2 impulse) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RigidBody2D", "apply_central_impulse");
	}
...
void RigidBody2D::apply_torque_impulse(const double torque) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RigidBody2D", "apply_torque_impulse");
	}
...
void RigidBody2D::add_central_force(const Vector2 force) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RigidBody2D", "add_central_force");
	}
	___godot_icall_void_Vector2(mb, (const Object *) this, force);
}
...
void RigidBody2D::add_torque(const double torque) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RigidBody2D", "add_torque");
	}
	___godot_icall_void_float(mb, (const Object *) this, torque);
}
