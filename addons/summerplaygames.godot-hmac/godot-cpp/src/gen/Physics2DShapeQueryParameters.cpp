...
void Physics2DShapeQueryParameters::set_collide_with_bodies(const bool enable) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Physics2DShapeQueryParameters", "set_collide_with_bodies");
	}
...
bool Physics2DShapeQueryParameters::is_collide_with_bodies_enabled() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Physics2DShapeQueryParameters", "is_collide_with_bodies_enabled");
	}
...
void Physics2DShapeQueryParameters::set_collide_with_areas(const bool enable) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Physics2DShapeQueryParameters", "set_collide_with_areas");
	}
	___godot_icall_void_bool(mb, (const Object *) this, enable);
}
...
bool Physics2DShapeQueryParameters::is_collide_with_areas_enabled() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Physics2DShapeQueryParameters", "is_collide_with_areas_enabled");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
