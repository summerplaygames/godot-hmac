...
String EditorFileSystemDirectory::get_file_script_class_name(const int64_t idx) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("EditorFileSystemDirectory", "get_file_script_class_name");
	}
	return ___godot_icall_String_int(mb, (const Object *) this, idx);
}
...
String EditorFileSystemDirectory::get_file_script_class_extends(const int64_t idx) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("EditorFileSystemDirectory", "get_file_script_class_extends");
	}
	return ___godot_icall_String_int(mb, (const Object *) this, idx);
}
