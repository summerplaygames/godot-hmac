...
void BitMap::grow_mask(const int64_t pixels, const Rect2 rect) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("BitMap", "grow_mask");
	}
	___godot_icall_void_int_Rect2(mb, (const Object *) this, pixels, rect);
}

Array BitMap::opaque_to_polygons(const Rect2 rect, const double epsilon) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("BitMap", "opaque_to_polygons");
	}
	return ___godot_icall_Array_Rect2_float(mb, (const Object *) this, rect, epsilon);
}
