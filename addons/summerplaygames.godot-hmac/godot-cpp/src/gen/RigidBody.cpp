...
void RigidBody::set_physics_material_override(const Ref<PhysicsMaterial> physics_material_override) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RigidBody", "set_physics_material_override");
	}
...
Ref<PhysicsMaterial> RigidBody::get_physics_material_override() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RigidBody", "get_physics_material_override");
	}
...
void RigidBody::_reload_physics_characteristics() {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RigidBody", "_reload_physics_characteristics");
	}
...
void RigidBody::add_central_force(const Vector3 force) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RigidBody", "add_central_force");
	}
...
void RigidBody::add_force(const Vector3 force, const Vector3 position) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RigidBody", "add_force");
	}
...
void RigidBody::add_torque(const Vector3 torque) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RigidBody", "add_torque");
	}
...
void RigidBody::apply_central_impulse(const Vector3 impulse) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RigidBody", "apply_central_impulse");
	}
