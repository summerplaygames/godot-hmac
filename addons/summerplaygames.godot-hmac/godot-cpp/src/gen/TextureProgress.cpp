...
void TextureProgress::set_tint_under(const Color tint) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TextureProgress", "set_tint_under");
	}
	___godot_icall_void_Color(mb, (const Object *) this, tint);
}

Color TextureProgress::get_tint_under() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TextureProgress", "get_tint_under");
	}
...
void TextureProgress::set_tint_progress(const Color tint) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TextureProgress", "set_tint_progress");
	}
	___godot_icall_void_Color(mb, (const Object *) this, tint);
}
...
Color TextureProgress::get_tint_progress() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TextureProgress", "get_tint_progress");
	}
	return ___godot_icall_Color(mb, (const Object *) this);
}
...
void TextureProgress::set_tint_over(const Color tint) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TextureProgress", "set_tint_over");
	}
	___godot_icall_void_Color(mb, (const Object *) this, tint);
}
...
Color TextureProgress::get_tint_over() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TextureProgress", "get_tint_over");
	}
	return ___godot_icall_Color(mb, (const Object *) this);
}
