...
void LineEdit::set_secret_character(const String character) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("LineEdit", "set_secret_character");
	}
	___godot_icall_void_String(mb, (const Object *) this, character);
}

String LineEdit::get_secret_character() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("LineEdit", "get_secret_character");
	}
	return ___godot_icall_String(mb, (const Object *) this);
}
...
void LineEdit::set_clear_button_enabled(const bool enable) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("LineEdit", "set_clear_button_enabled");
	}
	___godot_icall_void_bool(mb, (const Object *) this, enable);
}
...
bool LineEdit::is_clear_button_enabled() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("LineEdit", "is_clear_button_enabled");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
