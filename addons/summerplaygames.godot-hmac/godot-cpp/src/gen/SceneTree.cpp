...
void SceneTree::set_multiplayer(const Ref<MultiplayerAPI> multiplayer) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("SceneTree", "set_multiplayer");
	}
	___godot_icall_void_Object(mb, (const Object *) this, multiplayer.ptr());
}

Ref<MultiplayerAPI> SceneTree::get_multiplayer() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("SceneTree", "get_multiplayer");
	}
...
void SceneTree::set_multiplayer_poll_enabled(const bool enabled) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("SceneTree", "set_multiplayer_poll_enabled");
	}
	___godot_icall_void_bool(mb, (const Object *) this, enabled);
}
...
bool SceneTree::is_multiplayer_poll_enabled() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("SceneTree", "is_multiplayer_poll_enabled");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
