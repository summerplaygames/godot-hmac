...
void Curve3D::set_up_vector_enabled(const bool enable) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Curve3D", "set_up_vector_enabled");
	}
...
bool Curve3D::is_up_vector_enabled() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Curve3D", "is_up_vector_enabled");
	}
...
Vector3 Curve3D::interpolate_baked_up_vector(const double offset, const bool apply_tilt) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Curve3D", "interpolate_baked_up_vector");
	}
	return ___godot_icall_Vector3_float_bool(mb, (const Object *) this, offset, apply_tilt);
}
...
PoolVector3Array Curve3D::get_baked_up_vectors() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Curve3D", "get_baked_up_vectors");
	}
	return ___godot_icall_PoolVector3Array(mb, (const Object *) this);
}
...
Vector3 Curve3D::get_closest_point(const Vector3 to_point) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Curve3D", "get_closest_point");
	}
...
double Curve3D::get_closest_offset(const Vector3 to_point) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Curve3D", "get_closest_offset");
	}
	return ___godot_icall_float_Vector3(mb, (const Object *) this, to_point);
}
