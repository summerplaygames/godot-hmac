...
void CanvasItem::_edit_set_scale(const Vector2 scale) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("CanvasItem", "_edit_set_scale");
	}
...
Vector2 CanvasItem::_edit_get_scale() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("CanvasItem", "_edit_get_scale");
	}
	return ___godot_icall_Vector2(mb, (const Object *) this);
}
...
void CanvasItem::force_update_transform() {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("CanvasItem", "force_update_transform");
	}
	___godot_icall_void(mb, (const Object *) this);
}
