...
void TileMap::_set_celld(const Vector2 position, const Dictionary data) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TileMap", "_set_celld");
	}
	___godot_icall_void_Vector2_Dictionary(mb, (const Object *) this, position, data);
}
...
void TileMap::update_dirty_quadrants() {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TileMap", "update_dirty_quadrants");
	}
	___godot_icall_void(mb, (const Object *) this);
}
