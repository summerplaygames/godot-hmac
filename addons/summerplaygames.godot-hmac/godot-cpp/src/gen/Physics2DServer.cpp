...
void Physics2DServer::area_attach_canvas_instance_id(const RID area, const int64_t id) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Physics2DServer", "area_attach_canvas_instance_id");
	}
	___godot_icall_void_RID_int(mb, (const Object *) this, area, id);
}
...
int64_t Physics2DServer::area_get_canvas_instance_id(const RID area) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Physics2DServer", "area_get_canvas_instance_id");
	}
	return ___godot_icall_int_RID(mb, (const Object *) this, area);
}
...
void Physics2DServer::area_set_area_monitor_callback(const RID area, const Object *receiver, const String method) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Physics2DServer", "area_set_area_monitor_callback");
	}
	___godot_icall_void_RID_Object_String(mb, (const Object *) this, area, receiver, method);
}
...
void Physics2DServer::area_set_monitorable(const RID area, const bool monitorable) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Physics2DServer", "area_set_monitorable");
	}
	___godot_icall_void_RID_bool(mb, (const Object *) this, area, monitorable);
}
...
void Physics2DServer::body_attach_canvas_instance_id(const RID body, const int64_t id) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Physics2DServer", "body_attach_canvas_instance_id");
	}
	___godot_icall_void_RID_int(mb, (const Object *) this, body, id);
}
...
int64_t Physics2DServer::body_get_canvas_instance_id(const RID body) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Physics2DServer", "body_get_canvas_instance_id");
	}
	return ___godot_icall_int_RID(mb, (const Object *) this, body);
}
...
void Physics2DServer::body_apply_central_impulse(const RID body, const Vector2 impulse) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Physics2DServer", "body_apply_central_impulse");
	}
	___godot_icall_void_RID_Vector2(mb, (const Object *) this, body, impulse);
}

void Physics2DServer::body_apply_torque_impulse(const RID body, const double impulse) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Physics2DServer", "body_apply_torque_impulse");
	}
	___godot_icall_void_RID_float(mb, (const Object *) this, body, impulse);
}
...
void Physics2DServer::body_add_central_force(const RID body, const Vector2 force) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Physics2DServer", "body_add_central_force");
	}
	___godot_icall_void_RID_Vector2(mb, (const Object *) this, body, force);
}
...
void Physics2DServer::body_add_torque(const RID body, const double torque) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Physics2DServer", "body_add_torque");
	}
	___godot_icall_void_RID_float(mb, (const Object *) this, body, torque);
}
