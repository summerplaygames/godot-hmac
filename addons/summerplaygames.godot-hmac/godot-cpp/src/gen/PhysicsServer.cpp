...
void PhysicsServer::area_set_area_monitor_callback(const RID area, const Object *receiver, const String method) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PhysicsServer", "area_set_area_monitor_callback");
	}
	___godot_icall_void_RID_Object_String(mb, (const Object *) this, area, receiver, method);
}
...
void PhysicsServer::area_set_monitorable(const RID area, const bool monitorable) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PhysicsServer", "area_set_monitorable");
	}
...
void PhysicsServer::body_add_central_force(const RID body, const Vector3 force) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PhysicsServer", "body_add_central_force");
	}
	___godot_icall_void_RID_Vector3(mb, (const Object *) this, body, force);
}

void PhysicsServer::body_add_force(const RID body, const Vector3 force, const Vector3 position) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PhysicsServer", "body_add_force");
	}
	___godot_icall_void_RID_Vector3_Vector3(mb, (const Object *) this, body, force, position);
}

void PhysicsServer::body_add_torque(const RID body, const Vector3 torque) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PhysicsServer", "body_add_torque");
	}
	___godot_icall_void_RID_Vector3(mb, (const Object *) this, body, torque);
}

void PhysicsServer::body_apply_central_impulse(const RID body, const Vector3 impulse) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("PhysicsServer", "body_apply_central_impulse");
	}
