...
void Camera::set_cull_mask_bit(const int64_t layer, const bool enable) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Camera", "set_cull_mask_bit");
	}
	___godot_icall_void_int_bool(mb, (const Object *) this, layer, enable);
}

bool Camera::get_cull_mask_bit(const int64_t layer) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Camera", "get_cull_mask_bit");
	}
