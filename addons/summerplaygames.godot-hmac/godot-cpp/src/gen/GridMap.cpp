...
void GridMap::set_mesh_library(const Ref<MeshLibrary> mesh_library) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("GridMap", "set_mesh_library");
	}
	___godot_icall_void_Object(mb, (const Object *) this, mesh_library.ptr());
}

Ref<MeshLibrary> GridMap::get_mesh_library() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("GridMap", "get_mesh_library");
	}
	return Ref<MeshLibrary>::__internal_constructor(___godot_icall_Object(mb, (const Object *) this));
}
