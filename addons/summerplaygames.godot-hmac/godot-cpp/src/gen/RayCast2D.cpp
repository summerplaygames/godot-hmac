...
void RayCast2D::set_collide_with_areas(const bool enable) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RayCast2D", "set_collide_with_areas");
	}
...
bool RayCast2D::is_collide_with_areas_enabled() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RayCast2D", "is_collide_with_areas_enabled");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
...
void RayCast2D::set_collide_with_bodies(const bool enable) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RayCast2D", "set_collide_with_bodies");
	}
	___godot_icall_void_bool(mb, (const Object *) this, enable);
}
...
bool RayCast2D::is_collide_with_bodies_enabled() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("RayCast2D", "is_collide_with_bodies_enabled");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
