...
void NativeScript::set_script_class_name(const String class_name) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("NativeScript", "set_script_class_name");
	}
	___godot_icall_void_String(mb, (const Object *) this, class_name);
}
...
String NativeScript::get_script_class_name() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("NativeScript", "get_script_class_name");
	}
	return ___godot_icall_String(mb, (const Object *) this);
}
...
void NativeScript::set_script_class_icon_path(const String icon_path) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("NativeScript", "set_script_class_icon_path");
	}
	___godot_icall_void_String(mb, (const Object *) this, icon_path);
}

String NativeScript::get_script_class_icon_path() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("NativeScript", "get_script_class_icon_path");
	}
	return ___godot_icall_String(mb, (const Object *) this);
}
