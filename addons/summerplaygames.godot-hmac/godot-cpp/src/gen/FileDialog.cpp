...
void FileDialog::_tree_multi_selected(const Object *arg0, const int64_t arg1, const bool arg2) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("FileDialog", "_tree_multi_selected");
	}
	___godot_icall_void_Object_int_bool(mb, (const Object *) this, arg0, arg1, arg2);
}
...
LineEdit *FileDialog::get_line_edit() {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("FileDialog", "get_line_edit");
	}
