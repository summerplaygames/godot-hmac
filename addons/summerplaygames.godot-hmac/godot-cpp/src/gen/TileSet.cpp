...
void TileSet::autotile_set_size(const int64_t id, const Vector2 size) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TileSet", "autotile_set_size");
	}
	___godot_icall_void_int_Vector2(mb, (const Object *) this, id, size);
}

Vector2 TileSet::autotile_get_size(const int64_t id) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TileSet", "autotile_get_size");
	}
...
void TileSet::tile_set_modulate(const int64_t id, const Color color) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TileSet", "tile_set_modulate");
	}
	___godot_icall_void_int_Color(mb, (const Object *) this, id, color);
}

Color TileSet::tile_get_modulate(const int64_t id) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TileSet", "tile_get_modulate");
	}
	return ___godot_icall_Color_int(mb, (const Object *) this, id);
}
...
void TileSet::tile_set_shape_offset(const int64_t id, const int64_t shape_id, const Vector2 shape_offset) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TileSet", "tile_set_shape_offset");
	}
	___godot_icall_void_int_int_Vector2(mb, (const Object *) this, id, shape_id, shape_offset);
}

Vector2 TileSet::tile_get_shape_offset(const int64_t id, const int64_t shape_id) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TileSet", "tile_get_shape_offset");
	}
	return ___godot_icall_Vector2_int_int(mb, (const Object *) this, id, shape_id);
}
...
void TileSet::tile_set_tile_mode(const int64_t id, const int64_t tilemode) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TileSet", "tile_set_tile_mode");
	}
	___godot_icall_void_int_int(mb, (const Object *) this, id, tilemode);
}

TileSet::TileMode TileSet::tile_get_tile_mode(const int64_t id) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TileSet", "tile_get_tile_mode");
	}
	return (TileSet::TileMode) ___godot_icall_int_int(mb, (const Object *) this, id);
}
...
void TileSet::tile_set_z_index(const int64_t id, const int64_t z_index) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TileSet", "tile_set_z_index");
	}
	___godot_icall_void_int_int(mb, (const Object *) this, id, z_index);
}

int64_t TileSet::tile_get_z_index(const int64_t id) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("TileSet", "tile_get_z_index");
	}
	return ___godot_icall_int_int(mb, (const Object *) this, id);
}
