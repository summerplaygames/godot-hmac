...
Vector2 Curve2D::get_closest_point(const Vector2 to_point) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Curve2D", "get_closest_point");
	}
...
double Curve2D::get_closest_offset(const Vector2 to_point) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Curve2D", "get_closest_offset");
	}
	return ___godot_icall_float_Vector2(mb, (const Object *) this, to_point);
}
