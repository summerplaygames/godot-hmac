...
void Animation::track_swap(const int64_t idx, const int64_t with_idx) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "track_swap");
	}
	___godot_icall_void_int_int(mb, (const Object *) this, idx, with_idx);
}
...
int64_t Animation::bezier_track_insert_key(const int64_t track, const double time, const double value, const Vector2 in_handle, const Vector2 out_handle) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "bezier_track_insert_key");
	}
	return ___godot_icall_int_int_float_float_Vector2_Vector2(mb, (const Object *) this, track, time, value, in_handle, out_handle);
}

void Animation::bezier_track_set_key_value(const int64_t idx, const int64_t key_idx, const double value) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "bezier_track_set_key_value");
	}
	___godot_icall_void_int_int_float(mb, (const Object *) this, idx, key_idx, value);
}

void Animation::bezier_track_set_key_in_handle(const int64_t idx, const int64_t key_idx, const Vector2 in_handle) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "bezier_track_set_key_in_handle");
	}
	___godot_icall_void_int_int_Vector2(mb, (const Object *) this, idx, key_idx, in_handle);
}

void Animation::bezier_track_set_key_out_handle(const int64_t idx, const int64_t key_idx, const Vector2 out_handle) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "bezier_track_set_key_out_handle");
	}
	___godot_icall_void_int_int_Vector2(mb, (const Object *) this, idx, key_idx, out_handle);
}

double Animation::bezier_track_get_key_value(const int64_t idx, const int64_t key_idx) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "bezier_track_get_key_value");
	}
	return ___godot_icall_float_int_int(mb, (const Object *) this, idx, key_idx);
}

Vector2 Animation::bezier_track_get_key_in_handle(const int64_t idx, const int64_t key_idx) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "bezier_track_get_key_in_handle");
	}
	return ___godot_icall_Vector2_int_int(mb, (const Object *) this, idx, key_idx);
}

Vector2 Animation::bezier_track_get_key_out_handle(const int64_t idx, const int64_t key_idx) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "bezier_track_get_key_out_handle");
	}
	return ___godot_icall_Vector2_int_int(mb, (const Object *) this, idx, key_idx);
}

double Animation::bezier_track_interpolate(const int64_t track, const double time) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "bezier_track_interpolate");
	}
	return ___godot_icall_float_int_float(mb, (const Object *) this, track, time);
}

int64_t Animation::audio_track_insert_key(const int64_t track, const double time, const Ref<Resource> stream, const double start_offset, const double end_offset) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "audio_track_insert_key");
	}
	return ___godot_icall_int_int_float_Object_float_float(mb, (const Object *) this, track, time, stream.ptr(), start_offset, end_offset);
}

void Animation::audio_track_set_key_stream(const int64_t idx, const int64_t key_idx, const Ref<Resource> stream) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "audio_track_set_key_stream");
	}
	___godot_icall_void_int_int_Object(mb, (const Object *) this, idx, key_idx, stream.ptr());
}

void Animation::audio_track_set_key_start_offset(const int64_t idx, const int64_t key_idx, const double offset) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "audio_track_set_key_start_offset");
	}
	___godot_icall_void_int_int_float(mb, (const Object *) this, idx, key_idx, offset);
}

void Animation::audio_track_set_key_end_offset(const int64_t idx, const int64_t key_idx, const double offset) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "audio_track_set_key_end_offset");
	}
	___godot_icall_void_int_int_float(mb, (const Object *) this, idx, key_idx, offset);
}

Ref<Resource> Animation::audio_track_get_key_stream(const int64_t idx, const int64_t key_idx) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "audio_track_get_key_stream");
	}
	return Ref<Resource>::__internal_constructor(___godot_icall_Object_int_int(mb, (const Object *) this, idx, key_idx));
}

double Animation::audio_track_get_key_start_offset(const int64_t idx, const int64_t key_idx) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "audio_track_get_key_start_offset");
	}
	return ___godot_icall_float_int_int(mb, (const Object *) this, idx, key_idx);
}

double Animation::audio_track_get_key_end_offset(const int64_t idx, const int64_t key_idx) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "audio_track_get_key_end_offset");
	}
	return ___godot_icall_float_int_int(mb, (const Object *) this, idx, key_idx);
}

int64_t Animation::animation_track_insert_key(const int64_t track, const double time, const String animation) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "animation_track_insert_key");
	}
	return ___godot_icall_int_int_float_String(mb, (const Object *) this, track, time, animation);
}

void Animation::animation_track_set_key_animation(const int64_t idx, const int64_t key_idx, const String animation) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "animation_track_set_key_animation");
	}
	___godot_icall_void_int_int_String(mb, (const Object *) this, idx, key_idx, animation);
}

String Animation::animation_track_get_key_animation(const int64_t idx, const int64_t key_idx) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Animation", "animation_track_get_key_animation");
	}
	return ___godot_icall_String_int_int(mb, (const Object *) this, idx, key_idx);
}
