...
void Slider::set_scrollable(const bool scrollable) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Slider", "set_scrollable");
	}
	___godot_icall_void_bool(mb, (const Object *) this, scrollable);
}

bool Slider::is_scrollable() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Slider", "is_scrollable");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
