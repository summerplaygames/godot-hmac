...
void AudioStreamPlayer2D::set_stream_paused(const bool pause) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("AudioStreamPlayer2D", "set_stream_paused");
	}
...
bool AudioStreamPlayer2D::get_stream_paused() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("AudioStreamPlayer2D", "get_stream_paused");
	}
	return ___godot_icall_bool(mb, (const Object *) this);
}
