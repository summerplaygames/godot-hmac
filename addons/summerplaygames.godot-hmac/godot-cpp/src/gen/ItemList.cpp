...
void ItemList::set_item_icon_transposed(const int64_t idx, const bool rect) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("ItemList", "set_item_icon_transposed");
	}
	___godot_icall_void_int_bool(mb, (const Object *) this, idx, rect);
}

bool ItemList::is_item_icon_transposed(const int64_t idx) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("ItemList", "is_item_icon_transposed");
	}
...
void ItemList::set_item_icon_modulate(const int64_t idx, const Color modulate) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("ItemList", "set_item_icon_modulate");
	}
	___godot_icall_void_int_Color(mb, (const Object *) this, idx, modulate);
}

Color ItemList::get_item_icon_modulate(const int64_t idx) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("ItemList", "get_item_icon_modulate");
	}
...
void ItemList::set_item_custom_fg_color(const int64_t idx, const Color custom_fg_color) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("ItemList", "set_item_custom_fg_color");
	}
	___godot_icall_void_int_Color(mb, (const Object *) this, idx, custom_fg_color);
}

Color ItemList::get_item_custom_fg_color(const int64_t idx) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("ItemList", "get_item_custom_fg_color");
	}
	return ___godot_icall_Color_int(mb, (const Object *) this, idx);
}
...
void ItemList::move_item(const int64_t from_idx, const int64_t to_idx) {
	...
	___godot_icall_void_int_int(mb, (const Object *) this, from_idx, to_idx);
}
