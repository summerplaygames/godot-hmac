...
void MultiMesh::set_custom_data_format(const int64_t format) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("MultiMesh", "set_custom_data_format");
	}
	___godot_icall_void_int(mb, (const Object *) this, format);
}
...
MultiMesh::CustomDataFormat MultiMesh::get_custom_data_format() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("MultiMesh", "get_custom_data_format");
	}
	return (MultiMesh::CustomDataFormat) ___godot_icall_int(mb, (const Object *) this);
}
...
void MultiMesh::set_instance_custom_data(const int64_t instance, const Color custom_data) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("MultiMesh", "set_instance_custom_data");
	}
	___godot_icall_void_int_Color(mb, (const Object *) this, instance, custom_data);
}

Color MultiMesh::get_instance_custom_data(const int64_t instance) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("MultiMesh", "get_instance_custom_data");
	}
	return ___godot_icall_Color_int(mb, (const Object *) this, instance);
}
...
void MultiMesh::_set_custom_data_array(const PoolColorArray arg0) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("MultiMesh", "_set_custom_data_array");
	}
	___godot_icall_void_PoolColorArray(mb, (const Object *) this, arg0);
}
...
PoolColorArray MultiMesh::_get_custom_data_array() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("MultiMesh", "_get_custom_data_array");
	}
	return ___godot_icall_PoolColorArray(mb, (const Object *) this);
}
