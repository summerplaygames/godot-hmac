...
double Input::get_action_strength(const String action) const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Input", "get_action_strength");
	}
	return ___godot_icall_float_String(mb, (const Object *) this, action);
}
...
void Input::action_press(const String action, const double strength) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Input", "action_press");
	}
	___godot_icall_void_String_float(mb, (const Object *) this, action, strength);
}
...
void Input::set_default_cursor_shape(const int64_t shape) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("Input", "set_default_cursor_shape");
	}
