...
Array AudioServer::get_device_list() {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("AudioServer", "get_device_list");
	}
...
String AudioServer::get_device() {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("AudioServer", "get_device");
	}
...
void AudioServer::set_device(const String device) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("AudioServer", "set_device");
	}
	___godot_icall_void_String(mb, (const Object *) this, device);
}

Array AudioServer::capture_get_device_list() {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("AudioServer", "capture_get_device_list");
	}
	return ___godot_icall_Array(mb, (const Object *) this);
}
...
String AudioServer::capture_get_device() {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("AudioServer", "capture_get_device");
	}
	return ___godot_icall_String(mb, (const Object *) this);
}
...
void AudioServer::capture_set_device(const String name) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("AudioServer", "capture_set_device");
	}
