...
void DynamicFont::set_outline_size(const int64_t size) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("DynamicFont", "set_outline_size");
	}
...
int64_t DynamicFont::get_outline_size() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("DynamicFont", "get_outline_size");
	}
	return ___godot_icall_int(mb, (const Object *) this);
}
...
void DynamicFont::set_outline_color(const Color color) {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("DynamicFont", "set_outline_color");
	}
...
Color DynamicFont::get_outline_color() const {
	static godot_method_bind *mb = nullptr;
	if (mb == nullptr) {
		mb = godot::api->godot_method_bind_get_method("DynamicFont", "get_outline_color");
	}
